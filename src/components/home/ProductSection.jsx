...
import { Heart, ShoppingBag, ArrowRight, ChevronLeft, ChevronRight, ShoppingCart } from "lucide-react";
        ...
        >
            ...
            <div className="relative overflow-hidden rounded-[24px] bg-white border border-neutral-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] transition-all duration-500 group-hover:-translate-y-1 group-hover:shadow-[0_15px_45px_rgba(0,0,0,0.08)]">
                ...
                <div className="px-4 pb-4 pt-3.5">
                    ...
                    {/* Name */}
                    <h3 className="truncate text-[14px] font-bold tracking-tight text-neutral-900">
                        {product.name}
                    </h3>
                    ...
                    <div className="mt-2 flex items-center justify-between">
                        ...
                        {/* Discount */}
                        <span className="rounded-full bg-[#FFF0F2] px-2 py-1 text-[9px] font-bold text-[#FF1744]">
                            {Math.round(
